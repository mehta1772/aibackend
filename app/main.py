...
# Import routers
from app.routers import auth, users, bookings, services, dashboard, trash, documents, invoices, profiles, scorecard
...
origins = [
    "http://localhost:3000",
    "http://localhost:5173",
    "https://enigoal.in",  # Update with your Hostinger domain
]
